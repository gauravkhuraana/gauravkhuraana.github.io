...
const freeCourses: Course[] = [
  ...
  },
  {
    ...
    desc: 'Agentic AI video series built on the GH-600 certification material — agents, tools, and guardrails.',
    link: '/docs/AI/gh-600-agentic-ai',
    gradient: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)',
    badge: 'FREE',
    tags: ['AI', 'Certification'],
    cta: 'Start Learning →',
    priceLabel: 'Free',
    audience: 'Engineers moving from AI chat to AI agents',
    format: 'Video series in progress',
    support: 'Self-paced resources',
    outcome: 'Understand and govern agentic workflows',
  },
  {
    icon: '☁️',
