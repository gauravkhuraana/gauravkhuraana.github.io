...
<Layout
  ...
  <main>
    <div className="container margin-vert--lg">
      ...
      - **[Testing Fundamentals](/docs/Testing)** - Core testing concepts and methodologies
      - **[Automation Mastery](/docs/Automation)** - Complete automation learning path
      - **[AI in Testing](/docs/AI)** - Artificial Intelligence applications in testing
      - **[Tools & Technologies](/docs/Tools)** - Comprehensive tool guides and comparisons
      - **[Git & Version Control](/docs/Git)** - Essential Git commands and workflows
      ...
      **[📅 Book a Session](https://topmate.io/gauravkhurana)**
      ...
      ### For Beginners
      1. Start with [Testing Fundamentals](/docs/Testing)
      ...
      1. Explore [Advanced Automation Concepts](/docs/Automation#-framework-design-patterns)
      2. Learn about [AI Integration](/docs/AI)
      3. Master [Professional Tools](/docs/Tools)
      4. Contribute to open-source projects
      
      ### For Advanced Practitioners
      1. Dive into [AI-Powered Testing](/docs/AI)
      2. Build [Custom Frameworks](/docs/Automation#-framework-development-months-9-12)
