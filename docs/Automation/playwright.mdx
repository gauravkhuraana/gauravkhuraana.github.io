...
image: /img/og/automation-playwright-og.png
---
...
See Playwright in action as an intelligent agent that can explore your web application, generate test plans and scripts, and automatically fix issues — a glimpse into AI-assisted test automation.

<YouTubeEmbed videoId="q8PkTyA7lnE" title="Playwright can explore your web app | Generate Test plan/scripts | Fix them" />

<div style={{textAlign: 'center', margin: '20px 0'}}>
  <a 
    href="https://www.youtube.com/watch?v=q8PkTyA7lnE" 
    target="_blank" 
