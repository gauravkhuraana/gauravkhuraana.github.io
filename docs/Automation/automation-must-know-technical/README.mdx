...
<div style={{display: 'flex', gap: '10px', marginBottom: '20px', flexWrap: 'wrap'}}>
  <a href="https://www.youtube.com/@Udzial/playlists?sub_confirmation=1" target="_blank" style={{textDecoration: 'none'}}>
    <button style={{padding: '10px 20px', backgroundColor: '#ff0000', color: 'white', border: 'none', borderRadius: '5px', cursor: 'pointer'}}>
      📺 YouTube Channel
    </button>
  </a>
  <a href="https://topmate.io/gauravkhurana" target="_blank" style={{textDecoration: 'none'}}>
    <button style={{padding: '10px 20px', backgroundColor: '#007cff', color: 'white', border: 'none', borderRadius: '5px', cursor: 'pointer'}}>
      💬 Book 1:1 Session
    </button>
  </a>
  <a href="https://medium.com/@gauravkhurana" target="_blank" style={{textDecoration: 'none'}}>
    <button style={{padding: '10px 20px', backgroundColor: '#000000', color: 'white', border: 'none', borderRadius: '5px', cursor: 'pointer'}}>
      📝 Medium Articles
    </button>
  </a>
</div>
...
<div style={{display: 'flex', gap: '10px', marginTop: '20px', flexWrap: 'wrap'}}>
  <a href="https://www.youtube.com/@Udzial/playlists?sub_confirmation=1" target="_blank" style={{textDecoration: 'none'}}>
    <button style={{padding: '12px 24px', backgroundColor: '#ff0000', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer', fontSize: '16px'}}>
      🎥 Subscribe for Automation Tips
    </button>
  </a>
  <a href="https://topmate.io/gauravkhurana" target="_blank" style={{textDecoration: 'none'}}>
    <button style={{padding: '12px 24px', backgroundColor: '#007cff', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer', fontSize: '16px'}}>
      💼 Book Mentorship Session
    </button>
  </a>
  <a href="https://medium.com/@gauravkhurana" target="_blank" style={{textDecoration: 'none'}}>
    <button style={{padding: '12px 24px', backgroundColor: '#000000', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer', fontSize: '16px'}}>
