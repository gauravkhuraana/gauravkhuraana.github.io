...
image: /img/og/ai-qa-sessions-og.png
---
...
## ChatGPT for Testing and Automation

How can ChatGPT be useful in Testing and Automation? Learn practical ways to leverage AI in your QA workflow.

<YouTubeEmbed 
  videoId="bBQBTwQiBEk" 
  title="ChatGPT - How its useful in Testing and Automation"
/>

[Watch on YouTube](https://www.youtube.com/watch?v=bBQBTwQiBEk)

## ChatGPT Response Customization

<YouTubeEmbed 
  videoId="QJTc7_XhKNg" 
  title="ChatGPT Response Customization | Decide what you want in / with output"
/>

## Stop Wasting Tokens! JSON vs TOON

Learn about efficient token usage and understand the difference between JSON and TOON formats for better AI interactions.

<YouTubeEmbed 
  videoId="coY4wSzThOo" 
  title="Stop Wasting Tokens! JSON vs TOON Explained Simply"
/>
